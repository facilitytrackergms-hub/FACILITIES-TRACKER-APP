...
UPDATED: 2026-05-30 08:45:00 AM
...
window.navigateTo = async (view, context = null) => {
    ...
    try {
        if (view === 'dashboard' || view === 'facility_dashboard') {
            // FIXED: Path uses ../ to exit 'js' folder and enter root 'views' folder
            // FIXED: Export name matches 'renderFacilities' in your view file
        ...
        app.innerHTML = `
            <div style="padding:40px; text-align:center; font-family:Arial;">
                ...
                <p style="color:#4b5563;">Could not load: <b>${view}</b></p>
                <p style="font-size:0.85em; color:#9ca3af;">Check path: /views/v1_facilitiesDashboard.js</p>
