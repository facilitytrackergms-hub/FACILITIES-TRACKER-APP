...
UPDATED: 2026-05-29 09:25:00 AM
...
export async function renderFacilityControls(facility) {
    ...
    // Define global refresh function for badges using only the main.js channel
    window.refreshFacilityBadges = async (facilityId) => {
    ...
    // All buttons wired to window.navigateTo
...
// --- VER TAG ---
console.log("Updated: 2026-05-29 09:25 AM • v2_facilityControls.js");
